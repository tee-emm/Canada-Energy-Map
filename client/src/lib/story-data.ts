    ...
    letters: [
      {
        ...
        walletEvent: {
          ...
          options: [
            { id: 'w1', label: 'Buy full groceries', costLabel: '-$40', cost: 40, impact: { warmth: 1, agency: -1 } },
            { id: 'w2', label: 'Buy less food', costLabel: '$0', cost: 0, impact: { warmth: -1, agency: 1 } }
          ]
        }
      },
      {
        ...
        walletEvent: {
          ...
          options: [
            { id: 'buy-ups', label: 'Buy UPS Battery', costLabel: '-$200', cost: 200, impact: { reliability: 2, warmth: -1 } },
            { id: 'risk-it', label: 'Risk the outages', costLabel: '$0', cost: 0, impact: { reliability: -2, affordability: 1 } }
          ]
        }
      },
      {
      ...
      },
      {
        ...
        walletEvent: {
          ...
          options: [
            { id: 'fuel', label: 'Buy last propane canisters', costLabel: '-$100 (Price gouged)', cost: 100, impact: { warmth: 2, affordability: -2 } },
            { id: 'nothing', label: 'Hunker down', costLabel: '$0', cost: 0, impact: { warmth: -2, affordability: 0 } }
          ]
        }
      },
      {
    ...
    letters: [
      {
        ...
        walletEvent: {
          prompt: "Rent is due ($1,200) and Hydro is ($150). You have $1,300.",
          options: [
            { id: 'pay-both', label: 'Pay both', costLabel: '-$1,350 (Overdraft)', cost: 1350, impact: { affordability: -2, reliability: 1 } },
            { id: 'pay-rent', label: 'Pay rent only', costLabel: '-$1,200', cost: 1200, impact: { affordability: 1, reliability: -2 } },
            { id: 'pay-neither', label: 'Defer both payments', costLabel: '$0 (Consequences later)', cost: 0, impact: { affordability: 2, reliability: -2, agency: -1 } }
          ]
        }
      },
      {
      ...
      },
      {
        ...
        walletEvent: {
          ...
          options: [
            { id: 'meds', label: 'Buy cough syrup & meds', costLabel: '-$40', cost: 40, impact: { warmth: 0, agency: 1 } },
            { id: 'heat', label: 'Run heater 24/7', costLabel: '-$40 electricity', cost: 40, impact: { warmth: 2, agency: -1 } },
            { id: 'neither', label: 'Tough it out', costLabel: '$0', cost: 0, impact: { warmth: -1, agency: -1 } }
          ]
        }
      },
      {
    ...
    letters: [
      {
        ...
        walletEvent: {
          ...
          options: [
            { id: 'fill', label: 'Order fill on credit', costLabel: '-$800 (High interest)', cost: 800, impact: { warmth: 2, affordability: -2 } },
            { id: 'wood', label: 'Buy firewood cord', costLabel: '-$300', cost: 300, impact: { warmth: 1, affordability: -1 } }
          ]
        }
      },
      {
      ...
      },
      {
        ...
        walletEvent: {
          ...
          options: [
            { id: 'heat-tape', label: 'Buy heat tape for pipes', costLabel: '-$60', cost: 60, impact: { reliability: 2, affordability: -1 } },
            { id: 'food', label: 'Buy hearty groceries', costLabel: '-$60', cost: 60, impact: { warmth: 1, reliability: -1 } },
            { id: 'skip', label: 'Can\u2019t afford either', costLabel: '$0', cost: 0, impact: { warmth: -1, reliability: -1 } }
          ]
        }
      },
      {
    ...
    letters: [
      {
        ...
        walletEvent: {
          ...
          options: [
            { id: 'gen', label: 'Buy portable power station', costLabel: '-$400 (Credit Card)', cost: 400, impact: { reliability: 2, affordability: -2 } },
            { id: 'gas', label: 'Fill car gas tank', costLabel: '-$80', cost: 80, impact: { reliability: 1, affordability: 0 } }
          ]
        }
      },
      {
      ...
      },
      {
        ...
        walletEvent: {
          ...
          options: [
            { id: 'taxi', label: 'Call specialized transport', costLabel: '-$200', cost: 200, impact: { reliability: 2, affordability: -1 } },
            { id: 'drive', label: 'Drive yourself', costLabel: '$0 (High Risk)', cost: 0, impact: { reliability: -1, affordability: 1 } }
          ]
        }
      },
      {
